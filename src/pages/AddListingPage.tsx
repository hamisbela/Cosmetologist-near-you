...
const AddListingPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Add Your Cosmetology Business | List Your Services in Our Directory</title>
        <meta name="description" content="Add your cosmetology business to our directory. Reach new clients looking for beauty services, makeup, skincare, hair styling, and nail care in your area." />
      </Helmet>
      ...
      <main className="container mx-auto px-4 py-12">
        <header className="text-center mb-12">
          ...
          <p className="mt-4 text-xl text-gray-600 max-w-3xl mx-auto">
            Join our directory of licensed cosmetologists and beauty professionals and connect with potential clients searching for "cosmetologists near me"
          </p>
        </header>
            ...
            <form>
              ...
              <div className="mb-8">
                ...
                <textarea 
                  id="services"
                  rows={3}
                  placeholder="List your beauty services, specialties, and treatment options..."
                  required
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
                ></textarea>
              </div>
          ...
          <div className="mt-12 bg-purple-50 p-8 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-700">Gain exposure to potential clients actively searching for cosmetologists near them.</p>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-700">Connect with clients specifically looking for beauty services in their area.</p>
              </div>
