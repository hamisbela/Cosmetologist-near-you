# Cosmetologist Business Directory

This project generates a static website for a cosmetologist business directory using CSV data. The site includes individual pages for businesses, cities, states, and categories.
